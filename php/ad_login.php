...
$adminname = mysqli_real_escape_string($conn, $_POST['ad_name']); //prevent SQL injection
...
$_SESSION['login'] = $row['AdminName']; //initialise a session called 'login' to have a value of 'firstName'
